...
musicInfo.put("lyricist", "아이유");
%>
<div class="profile d-flex border border-success p-3">
	<div>
		<img src="<%=artistInfo.get("photo")%>" alt="아티스트 사진" width="150px">
	</div>
	<div class="artistInfo ml-2">
...
<%-- 곡 목록 영역 --%>
<h4 class="font-weight-bold mt-4">곡 목록</h4>

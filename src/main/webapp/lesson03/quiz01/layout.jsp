...
%>
	<div id="wrap" class="container">
		<header >
			<h1 class="logo font-weight-bold text-center text-danger">Sk Broadband IPTV</h1>
			<nav class="d-felx align-items-center bg-danger">
		...
		<footer class="text-center">Copyright © marondal 2021</footer>
	</div>
</body>
</html>